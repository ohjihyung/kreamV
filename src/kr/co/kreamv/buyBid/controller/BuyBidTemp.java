...
@WebServlet("/buyBidTemp.do")
public class BuyBidTemp extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("buy_bid_price", request.getParameter("buy_bid_price"));
		request.setAttribute("buy_bid_fdate", request.getParameter("buy_bid_fdate"));
