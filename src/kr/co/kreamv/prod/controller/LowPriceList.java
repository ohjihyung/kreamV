...
@WebServlet("/lowPriceList.do")
public class LowPriceList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ProdVO> lowPriceList = service.lowPriceList();
		
		String jsonData = gson.toJson(lowPriceList);
