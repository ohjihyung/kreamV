...
public class PassFind extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Object mail = service.passFind(nameHp);
		...
		if(mail == null) {
			...
			String pass = service.sendMailPass((String)mail);
...
//			System.out.println(id);
			 ...
			 String host = "smtp.naver.com"; 
		        ...
		        try {
		            ...
		            message.addRecipient(Message.RecipientType.TO, new InternetAddress("seungjuin8@gmail.com"));// mailResult

		            // 메일 제목
		            message.setSubject("kreamv pass");
...
//		            System.out.println("Success Message Send");
		        ...
		        stringResult = gson.toJson("해당 이매일로 비밀번호가 발송되었습니다");
		        out.println(stringResult);
				response.flushBuffer();
		}
